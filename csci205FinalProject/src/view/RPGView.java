...
import static view.wrapper.NPCImageViewWrapper.IMAGE_PATH_PARENT_DIR;
...
public class RPGView {
    ...
    /**
     * The map that stores all the ImageView objects using the ImageType enum as a key
     */
...
//        this.rightPane.getChildren().add(this.toRoomButtons);
        ...
        this.centerPane.setMinHeight(800);
        this.centerPane.setMinWidth(1400);
        this.loadImages();
    ...
    public void loadImages() {
        ...
        this.imageViews.put(ImageType.RIGHTARROW, loadImage("img/arrow-right.png"));
    ...
    /**
     * Takes a file path leading to an image and converts it to an ImageView object
     ...
     * @param defaultBubble the bubble that will be displayed if the string doesn't meet the criteria for other bubbles
    ...
    public ImageView handleActionBubble(ImageType defaultBubble, String action) {
        ...
        if (action.contains("missed and did no damage") || action.contains("did 0 damage")) {
